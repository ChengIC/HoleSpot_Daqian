...
python eval.py --cuda_device 1 --scales 0 --scheduler_step_size 4 --load_weights_folder $weights_name --batch 6  --dataset kitti --model_name mono_model --png --data_path /mnt/nas/kaichen/compete/png --log_name $log_name
